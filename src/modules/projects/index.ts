...
class ProjectRoutes implements Route {
	...
	public initRoute() {
        ...
        this.router.get('/',(req,res) => { //Get all Projects
        ...
        this.router.post('/',(req,res) => { //Insert a new project in dataBase
            connection(this.tableName)
                .insert(				
                    { 	
		...
		this.router.get('/:id_project',(req,res) => { //Get a especific project
        ...
        this.router.get('/:tipo_projeto',(req,res) => { //Get all Project per type
