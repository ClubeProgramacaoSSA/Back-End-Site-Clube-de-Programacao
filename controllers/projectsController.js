...
exports.getProjects = async (req, res, next) => { //Pega todos os projetos
    try{
        const responseData = await postgre.executeQuerySql("SELECT * FROM TB_projeto;");
...
exports.getProject = async (req, res, next) => { //Pega apenas 1 projeto.
...
exports.postProject = async (req, res, next) => { // Cadastro de Projetos.
    const {ID_projeto, 
        ID_lider, 
        ID_imagem, 
        descricao, 
...
exports.putProject = async (req, res, next) => { // Edição de projetos.
    const {ID_projeto, 
        ID_lider , 
        ID_imagem, 
        descricao, 
